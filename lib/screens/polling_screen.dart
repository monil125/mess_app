        ...
        child: Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [Colors.yellow[800],Colors.green[300]],
            ...
            Column(
              ...
              Row(
                children: <Widget>[
                  ...
                  Text('Good',style: TextStyle(fontSize: 20,color: Colors.blue[900]),)
                ],
              ),
              ...
              Row(
                children: <Widget>[
                  ...
                  Text('Fine',style: TextStyle(fontSize: 20,color: Colors.blue[900]),)
                ],
              ),
              Row(
                children: <Widget>[
                  ...
                  Text('Bad',style: TextStyle(fontSize: 20,color: Colors.blue[900]),)
                ],
              )
            ],)
          ],),
